...
<header class="">
    <div class="w-full bg-cover bg-center" style="height: 75vh; background-image: url('{{ URL::asset('developments/banners/5.webp')}}'), url('{{ URL::asset('developments/banners/5.webp')}}');">
