...
<header>
    <div class="w-full bg-cover bg-center" style="margin-top: 60px; height: 40vh; background-image: url('{{ URL::asset('home/esnaad images/developments/2-1.jpg')}}'), url('{{ URL::asset('assets/img/img-error2.webp')}}');">
