    ...
    <div class="w-full bg-cover bg-top" style="height:75vh; background-image: url('{{URL::asset('front/images/002.webp')}}'), url('{{ URL::asset('assets/img/img-error2.webp')}}');">
        <div class="flex items-center justify-left h-full w-full bg-black bg-opacity-60">
            <div class="container mx-auto ">
                @if($langSeg == 'ar')
                    <h1 class="text-white text-2xl font-thin uppercase md:text-4xl px-4" dir="rtl">
                        شكرًا لك
                    </h1>
                @else
                    <h1 class="text-white text-2xl font-thin uppercase md:text-4xl px-4">
                        Thank you for your interest!
                        <br>
                    </h1>

                    <p class="text-white text-md font-thin xl:text-lg mt-5 px-4">
