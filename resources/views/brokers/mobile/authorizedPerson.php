<div class="grid grid-cols-1 gap-4">
    ...
    <div>
        ...
        <td>
            <select name="authorized_p_country_code"  class="w-full" >
        ...
        <td><input type="number" name="authorized_p_contact" id="authorized_p_contact" class="w-full" placeholder="eg: 4 123 4567"></td>
    </div>
