    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="flex">
                ...
                <input type="text" name="authorized_p_contact" id="authorized_p_contact" placeholder="ex: 501234567" class="border  w-full  bg-transparent focus:outline-none focus:border-white focus:ring-white" required>
            </td>
        </tr>
