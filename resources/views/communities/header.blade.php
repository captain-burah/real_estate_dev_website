...
@notmobile
    ...
    <header class="">
        <div class="w-full bg-cover bg-center mb-4" style="height: 75vh; background-image: url('{{ URL::asset('home/esnaad images/community/4-1.jpg')}}'), url('{{ URL::asset('assets/img/img-error2.webp')}}');">
