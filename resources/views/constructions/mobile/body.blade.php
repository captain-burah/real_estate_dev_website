                        ...
                        <div class="row my-2 px-4">
                            <div>
                                ...
                                <div class="mt-2 h-6 relative w-auto rounded-full overflow-hidden">
                                    ...
                                    <div class=" h-full bg-green-400 sm:bg-green-500 absolute" style="width:{{$growth}}%"><div class="h-full w-full mx-auto text-sm text-center pt-1 text-white font-bold"> &nbsp; &nbsp;</div></div>
                                </div>
