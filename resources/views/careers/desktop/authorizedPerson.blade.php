<table class="w-full mt-8" @if($langSeg == 'ar') dir="rtl" @endif>
    <tbody>
        ...
        <tr>
            ...
            <td><input type="text" name="applicant_name" id="applicant_name"  class=" w-full  bg-transparent focus:outline-none focus:border-white focus:ring-white" required></td>
        </tr>

        <tr>
            <td>{{__('frontend.careerFormEmail')}}</td>
            <td><input type="text" name="applicant_email" id="applicant_email"  class=" w-full  bg-transparent focus:outline-none focus:border-white focus:ring-white" required ></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <table class="w-full">
                    ...
                    <td><input type="text" name="applicant_phone" id="applicant_phone" placeholder="501234567" class="border w-full  bg-transparent focus:outline-none focus:border-white focus:ring-white" required></td>
        ...
        <tr>
            ...
            <td><input type="text" name="applicant_languages" id="applicant_languages" class=" w-full  bg-transparent focus:outline-none focus:border-white focus:ring-white" required></td>
        </tr>   

        <tr>
            <td>{{__('frontend.careerFormRole')}}</td>
            <td><input type="text" name="applicant_job" id="applicant_job" class=" w-full  bg-transparent focus:outline-none focus:border-white focus:ring-white" required></td>
        </tr>        
