    ...
    <div class="row mb-4">
        <div class="grid md:grid-cols-2 gap-2 mx-auto">
            ...
            <div class="text-center py-4 sm:py-4 w-full mt-2">
                <a href="{{ asset('/'.$langSeg.'/developments/the-spark-by-esnaad')}}" title="THE SPARK BY ESNAAD" alt="THE SPARK BY ESNAAD" class="bg-white text-base text-black py-3 px-10 rounded-0">
                    <span id="buttonText">
                        @if ($langSeg=='ar')
                            اكتشف المزيد
                        @else
