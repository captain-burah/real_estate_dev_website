...
<div class="container sm:mx-auto mx-0 px-0 my-8 mx-auto">
    <div class="">
        <div class="mx-0">
            <button onclick="openModal('mymodalcentered-community-register')"   class=" w-full bg-gray-900 text-lg xl:text-base border-4 text-black bg-white py-1 px-2 rounded-0" type="button">
    ...
    <div class="p-2 flex justify-center items-center fixed left-0 top-0 w-full h-full bg-black bg-opacity-80 transition-opacity duration-300 opacity-0">
        <div class="bg-white flex rounded-0 w-full relative">
            ...
            <div class="flex flex-col items-start w-full" id="form_ready">
                ...
                <form class="flex flex-col items-start w-full" id="new-community-details-mobile-form" method="post" action="/en/communities/register-your-interest">
                    @csrf
                    ...
                    <div class="p-4 flex justify-end items-center w-full">
                        ...
                        <button type="submit" id="submitForm" class="bg-black hover:bg-white border border-black text-white hover:text-black font-bold py-2 px-4 rounded-0 ml-3">
                            Register Your Interest
                        </button>
...
@section('intel-input')
    ...
    <script>
        ...
        if (getCookie('_TQMSlPTdN6Hwxl')) {
            ...
            $('#new-community-details-mobile-form').on('submit', function(e){
                ...
                */
                ...
                $.ajax({
                    ...
                    {
                        'X-CSRF-TOKEN': $('meta[name="XSRF-TOKEN"]').attr('content'),
                        'Access-Control-Allow-Origin': 'https://esnaad.com/en/communities/register-your-interest'
                    },
                    ...
                    success:function(data) 
                    {
                        if($.isEmptyObject(data.error)){ //---if success
                            setCookie("_TQMSlPTdN6Hwxl", true, 1); //---set a cookie
                            document.location.href = '/en/community-inquiry/thanks'; //---redirect to thank you page for seo
                        }else{
