...
<header class="">
    <div class="w-full bg-cover bg-center" style="height: 75vh; background-image: url('{{ URL::asset('assets/img/curved-images/curved11-small.jpg')}}'), url('{{ URL::asset('assets/img/img-error2.webp')}}');">
